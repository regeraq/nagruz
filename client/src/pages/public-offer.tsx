    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12 pt-24">
        <Card className="bg-card text-foreground">
          <CardHeader>
            <CardTitle className="text-2xl md:text-3xl text-foreground">{t("legal_offer_title")}</CardTitle>
          </CardHeader>
          <CardContent className="prose prose-slate dark:prose-invert max-w-none text-foreground">
            {map.get("legal_offer_body") ? (
              <CmsBlocks
                text={map.get("legal_offer_body") || ""}
                vars={{ operator_name: sellerName, operator_inn: sellerInn, operator_ogrn: sellerOgrn, contact_email: contactEmail, contact_phone: contactPhone, contact_address: contactAddress }}
              />
            ) : (
